...
import me.scolastico.tools.etc.StringSplitterKt;
...
public class RSAConverter {
  ...
  public static String publicToPEM(PublicKey publicKey) {
    ...
    for (String line: StringSplitterKt.splitStringByLength(Base64.getEncoder().encodeToString(publicKey.getEncoded()), 64)) {
  ...
  public static String privateToPEM(PrivateKey privateKey) {
    ...
    for (String line: StringSplitterKt.splitStringByLength(Base64.getEncoder().encodeToString(privateKey.getEncoded()), 64)) {
      ret.append(line).append("\n");
    }
