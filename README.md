...
```
### Other:
Instructions for installing with a different build manager can be found [here](https://search.maven.org/artifact/me.scolastico/tools/2.2.3/jar).

## Documentation
You can find the latest api docs [here (javadoc)](https://scolastico-dev.github.io/s.Tools/javadoc/) or [here (dokka)](https://scolastico-dev.github.io/s.Tools/dokka/).
